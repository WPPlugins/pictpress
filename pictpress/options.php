...
<form name="form1" method="post" action="options.php"> 
	...
	(<?php echo get_settings('fileupload_realpath'); ?>).
	...
	URL used for retrieving a resized image. You can use it to define a nice URL for resized images, e.g. equal to pp_cache_dir, but then you will also have to provide a RewriteRule in .htaccess to the resize.php script.
	</td> 
	</tr> 
    </table> 
    </fieldset> 
